        function calcularAvaliacao() {
            ...
            if (proTString.length <= "0") {
                alert("Preencha o campo \"Protocolo Geral\"")
            ...
            let nrua = document.querySelector('input#ruaC').value;
            let nNumero = document.querySelector('input#numeroCasaC').value;
            let bairroC = document.querySelector('input#bairroC').value;
            ...
            Terrenos Urbanos do <strong>CTM (Código Tributário Municipal)</strong>, verifiquei que o <strong>Lote ${lote} </strong>da <strong>Quadra ${quadra}</strong> localizado no <strong>${setSelect}</strong> com área total de <strong>${n} m2</strong>
            (${extensoSZero} Metros Quadrados), com área construída de <strong>${ac} m2</strong>
            (${extensoCZero} metros quadrados), localizado na <strong> Rua ${nrua}, N° ${nNumero}, no Bairro ${bairroC},
            ...
            valorVenais.innerHTML = `<p>
                    ...
                    <p>
                        <strong>*Valor total do Imóvel:</strong> <u>${totalImovels}</u> (Sendo ${valorVenalLotes} o valor do lote ${lote}, localizado na Quadra ${quadra} do <strong>${setSelect}</strong> e a área construida avaliada em ${valorAcabaFinal}. <i>Calculo de acordo com o código tributário 544/2005, onde o valor é  ${valorm2imovelSetor} por M²).</i><strong>(*VT)</strong>
                    </p>
                    <p>
            ...
            tituloSalvar.innerHTML = `${funcSelecionado}`
          

            window.alert(`<button>Imprimir</button>`)
