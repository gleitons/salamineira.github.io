...
for (let i = 0; i < numeroDigitado.length; i++) {
    numeroDigitado[i].addEventListener('click', () => {
        ...
        if (numeroUrna[0].innerHTML == '') {
            ...
            tic.play()
        } else if (numeroUrna[3].innerHTML == '') {
            numeroUrna[3].textContent = numeroDigitado[i].innerHTML
            tic.play()
        } else {
...
document.addEventListener('click', () => {
    const numeroInseridoNaUrna = `${numeroUrna[0].innerHTML}${numeroUrna[1].innerHTML}${numeroUrna[2].innerHTML}${numeroUrna[3].innerHTML}`
...
function fazPiscar() {
    if (numeroUrna[0].innerHTML.toString().length == 0) {
        ...
        numeroUrna[3].classList.remove('pisca')
        ...
        numeroUrna[3].classList.remove('pisca')
    } else if (numeroUrna[3].innerHTML.toString().length == 0) {
        numeroUrna[0].classList.remove('pisca')
        numeroUrna[1].classList.remove('pisca')
        numeroUrna[2].classList.remove('pisca')
        numeroUrna[3].classList.add('pisca')
    } else {
        numeroUrna[0].classList.remove('pisca')
        numeroUrna[1].classList.remove('pisca')
        numeroUrna[2].classList.remove('pisca')
