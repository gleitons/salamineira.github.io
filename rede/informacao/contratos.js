...
function adicionarPro() {
    ...
    <i class="bi bi-x-circle-fill" onclick="fecharProp(${ClassProp})">Fechar</i>
        ...
        <select name="proP" id="prop${ClassProp + 200}">
        <option value="">Selecione</option>
        <option >Mesmo Endereço</option>  
        <option >Novo Endereço</option>     
        </select> <br>
       <div class="newEnderecoProprietario">
       ...
       <div class="insereVendedor">
       <button>Inserir Vendedor</button>
   </div>
...
function copiaEnderecoVendedor(vendedor) {
