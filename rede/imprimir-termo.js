...
function criadorDePages(cod) {
    ...
    document.querySelector('#pageOne').innerHTML = `
    <p>Termo de doação que entre si fazem, de um lado <span id="insereVendedores"></span>, representada pelo Sr. JOSE RAUL REIS, Prefeito Municipal, como Doador, e de outro Lado como Donatário: JOÃO PAULO BARBOSA NOBRE , pessoa Física inscrito no CPF sob o n°.117.043.366-94 e RG de n°. MG-18.286.629, residente e domiciliado, neste município de Lagoa dos Patos-MG. 
    </p>

    <p>Imóvel doado: Um lote Urbano de n° 0007, Quadra n° 011A, Setor 05, localizado na Rua Dona Guiomar, S/N, Bairro Independência, com área de 191 m², (Cento e Noventa e Um metros quadrados), com as seguintes descrições: Frente medindo 10,0m (Dez Metros) lineares, o fundo medindo 10,00m (Dez metros) lineares, a lateral direita medindo 19,00m (Dezenove metros)  lineares e a lateral esquerda medindo 19,14m (Dezenove Metros e Quatorze centímetros).
    </p>

    <p>Saibam quanto este instrumento de Termo de Doação virem a pertencer que, o Sr. JOSE RAUL REIS - Prefeito Municipal, brasileiro, casado, inscrito no CPF nº.004.310.656-08, residente e domiciliado nesta Cidade de Lagoa dos Patos, na Rua Dona Ducha n°. 40, sendo legitimo representante legal deste município de Lagoa dos Patos</p>

    <p>e que nesta data, resolve de livre e espontânea vontade, Um lote Urbano de n° 0007, Quadra n° 011A, Setor 05, localizado na Rua Dona Guiomar, S/N, Bairro Independência, com área de 191 m², (Cento e Noventa e Sete metros quadrados), com as seguintes descrições: Frente medindo 10,00m (Dez Metros) lineares, o fundo medindo 10,00m (Dez metros) lineares, a lateral direita medindo 19,00m (Dezenove metros)  lineares e a lateral esquerda medindo 19,14m (Dezenove Metros e Quatorze centímetros).</p>
    <p></p>
