...
function arrayFuncionario() {
    const response = localStorage.getItem('funcionariosLDP')
...
function cadastroFuncionario() {
    ...
    const nMatricula = document.querySelector('#nMatricula').value;
    const nCPF = document.querySelector('#nCPF').value;
    const nAdmissao = document.querySelector('#nAdmissao').value;
    const nFuncao = document.querySelector('#nFuncao').value;
    ...
    addFuncionario.push(dadosFunc)

    console.log(addFuncionario)
    localStorage.setItem('funcionariosLDP', JSON.stringify(addFuncionario))
}
...
function abriForm() {
    ...
    <div>
        ...
        <button type="submit" onclick="cadastroFuncionario()">Cadastrar</button>                       
...
async function gerarFuncionario() {
    ...
    data.map((func) => {
        ...
        //console.log(`<option value="${func.nome}">${func.nome}</option>`)
    })
